...
int main(int argc, const char *argv[])
{
    ...
    for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex+=imgStepWidth)
    {
        ...
        cout << detectorType << " detection with n=" << keypoints.size() << " keypoints in " << 1000 * elapsed / 1.0 << " ms" << endl;
        totaltime += elapsed;
        ...
        totaltime += elapsed;
        cout << descriptorType << " descriptor extraction in " << 1000 * elapsed / 1.0 << " ms" << endl;
