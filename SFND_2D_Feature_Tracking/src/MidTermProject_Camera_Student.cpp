...
int main(int argc, const char *argv[])
{
	...
	double elapsed = detKeypoints(detectorType, keypoints, imgGray, false);
	totaltime += elapsed;
        //// EOF STUDENT ASSIGNMENT
	    ...
	    keypoints.erase(remove_if(keypoints.begin(),
				      keypoints.end(),
        ...
        cv::Mat descriptors;
        elapsed = descKeypoints((dataBuffer.end() - 1)->keypoints, (dataBuffer.end() - 1)->cameraImg, descriptors, descriptorType);
	totaltime += elapsed;
        //// EOF STUDENT ASSIGNMENT
        ...
        if (dataBuffer.size() > 1) // wait until at least two images have been processed
        {
            ...
            cout << "Number of matched key points for " << imgIndex << " is : " << matches.size() << endl;
    ...
    cout << "total time to process 10 frames is " << totaltime << endl;
    return 0;
}
